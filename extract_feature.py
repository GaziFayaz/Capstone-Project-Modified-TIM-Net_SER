...
SUBESCO_LABEL = ("Angry", "Fear", "Happy", "Neutral", "Sad")
LABEL_DICT = {"CASIA":CASIA_LABEL,"EMODB":EMODB_LABEL,"IEMOCAP":IEMOCAP_LABEL,"EMOVO":EMOVO_LABEL,"SAVEE":SAVEE_LABEL,"RAVDE":RAVDE_LABEL, "BANGLA_SER": BANGLA_SER_LABEL, "COMBINED": COMBINED_LABEL, "COMBINED_NEW": COMBINED_NEW_LABEL, "SUBESCO": SUBESCO_LABEL}
PATH_DICT = {"CASIA":"./CASIA_MFCC_88","EMODB":"./EMODB_MFCC_96","IEMOCAP":"./IEMOCAP_MFCC_310","EMOVO":"./EMOVO_MFCC_96","SAVEE":"./SAVEE_MFCC_130","RAVDE":"./RAVDE_MFCC_110", "BANGLA_SER": "./BANGLA_SER_MFCC_88", "COMBINED": "./COMBINED_MFCC_90", "COMBINED_NEW": "./COMBINED_NEW_MFCC_90", "SUBESCO":"./SUBESCO_MFCC_133"}
